...
const HANDLED_OUTSIDE_MANIFEST = new Map([
  ...
  // this list need not grow) is logged in .context/app/platform-divergences.md.
  [
    'ProjectMember',
    'Hub app table. Exported via lib/app/data-export.ts → `projectMemberships`; guarded by tests/unit/lib/app/data-export.test.ts.',
  ],
  [
    'TaskClaim',
    'Hub app table. Exported via lib/app/data-export.ts → `taskClaims`; guarded by tests/unit/lib/app/data-export.test.ts.',
  ],
  [
    'ProjectEvent',
