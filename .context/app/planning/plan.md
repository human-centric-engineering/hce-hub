...
| 09 | `f-plan-view` | Simon (**in flight**) | f-projects, f-hub-capabilities | 2 (was 4) | Feature-level Plan view (topological ordering) |
...
*Owner:* Simon · *Status:* **in flight** · *Depends on:* f-projects, f-hub-capabilities · *recommended 2 PRs (API+planOrder ↔ UI), sized down from indicative 4 (HB3) — pending owner confirmation* · *Detailed plan:* [[f-plan-view]]
